...
public class Valudate {
    ...
    public void testNew() {
        ...
        Two two = constructorOneParam.apply(22); // TODO: fix in this line
        assertEquals((long) two.i, (long) 22);

        Two two_ = constructor.apply(11, 10); // TODO: fix in this line
        assertEquals((long) two_.i, (long) 11);
    }

    @Test
    public void testFlatMap() {
        List<String> first = Arrays.asList("0", "3"); // TODO: fix in this line
        List<String> second = Arrays.asList("3", "5"); // TODO: fix in this line
