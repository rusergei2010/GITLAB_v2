...
public class Lambdas03Exercise {
    ...
    public void generic1() {
        final GenericProduct<Integer> prod = (Integer a, int i) -> { return a * i; }; // TODO: Use statement com.data.lambda
    ...
    public void generic2() {
        final GenericProduct<Integer> prod = (a, i) -> a * i; // TODO: Use expression com.data.lambda
