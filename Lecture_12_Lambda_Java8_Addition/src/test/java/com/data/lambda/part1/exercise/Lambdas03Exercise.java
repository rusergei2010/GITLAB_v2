...
public class Lambdas03Exercise {
    ...
    public void generic1() {
        final GenericProduct<Integer> prod = (a, i) -> a * i; // Use statement com.data.lambda
    ...
    public void generic2() {
        final GenericProduct<Integer> prod = Lambdas03Exercise::prod; //Use expression com.data.lambda
