...
public class FunctionCombination {
    ...
    public void personToInt0() {
        ...
        assertEquals(Integer.valueOf(4), lastNameLength.apply(new Person("a", "abcd", 0))); //  fix
    }
    ...
    public void personToInt2() {
        ...
        assertEquals(Integer.valueOf(5), lastNameLength.apply(new Person("a", "abcde", 0))); //  fix
    }
}