...
public class FunctionCombination {
    ...
    public void personToInt0() {
        ...
        assertEquals(Integer.valueOf(4), lastNameLength.apply(new Person("a", "abcd", 0))); // TODO : fix
    }
    ...
    public void personToInt2() {
        ...
        assertEquals(Integer.valueOf(4), lastNameLength.apply(new Person("a", "abde", 0))); // TODO: fix
    }
}
