...
public class ArrowNotationExercise {
    ...
    final Function<Person, String> getFullName = (p) -> p.getLastName().concat(" ").concat(p.getFirstName());
    ...
    public void getAgeOfPersonWithTheLongestFullName() {
        // Person -> String
        final Function<Person, String> getFullName = (p) -> p.getLastName().concat(" ").concat(p.getFirstName());// TODO
