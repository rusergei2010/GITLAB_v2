...
public class Mapping {
    ...
    private static class MapHelper<T> {
        ...
        public <R> MapHelper<R> map(Function<T, R> f) {
            ...
            getList().forEach(a -> list.add(f.apply(a)));
        ...
        final List<Employee> mappedEmployees =
                new MapHelper<>(employees)
                        ...
                        * */
                        ...
                        .map(e -> e.withJobHistory(qaUpper(e.getJobHistory())))
                        .getList();
    ...
    private List<JobHistoryEntry> qaUpper(List<JobHistoryEntry> jobHistory) {
        jobHistory.replaceAll(
                jobHistoryEntry -> "qa".equalsIgnoreCase(jobHistoryEntry.getPosition())
    ...
    private List<JobHistoryEntry> addOneYear(List<JobHistoryEntry> jobHistory) {
        jobHistory.replaceAll(
                jobHistoryEntry -> jobHistoryEntry.withDuration(jobHistoryEntry.getDuration() + 1));
        return jobHistory;
    }
    ...
    private static class LazyMapHelper<T, R> {
        ...
        public <R2> LazyMapHelper<T, R2> map(Function<R, R2> f) {
            // TODO
            //throw new UnsupportedOperationException();
            return new LazyMapHelper<>(list, a -> f.apply(function.apply(a)));
        }
    ...
    public void lazy_mapping() {
        ...
        final List<Employee> mappedEmployees =
                LazyMapHelper.from(employees)
                        ...
                        .map(TODO) // replace qa with QA
                        * */
                        .map(a -> a.withPerson(a.getPerson().withFirstName("John")))
                        .map(a -> a.withJobHistory(addOneYear(a.getJobHistory())))
                        .map(a -> a.withJobHistory(qaUpper(a.getJobHistory())))
                        .force();
