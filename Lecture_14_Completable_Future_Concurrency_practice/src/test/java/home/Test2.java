...
public class Test2 {
    ...
    public void testSupply() throws ExecutionException, InterruptedException {
        ...
        CompletableFuture<String> result = completableFuture.thenApply(s -> s + " / Second Task");//thenApply(s -> s + " / Second Task");; //thenApply(s -> s + " / Second Task");
    ...
    public void testComposeAsyncSleep() throws ExecutionException, InterruptedException {
        ...
        CompletableFuture<String> completableFuture = CompletableFuture.supplyAsync(() -> {
            sleep(2100); // TODO: Fix the timeout here
