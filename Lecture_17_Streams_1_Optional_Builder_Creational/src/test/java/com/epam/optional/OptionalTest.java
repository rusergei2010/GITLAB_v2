...
public class OptionalTest {
    ...
    /**
     * TODO: 1
     *  - Create the model with the House -> Building in the same way as for the Car -> Vehicle
...
//                .setBrand("Audi") // omit brand name
    ...
    public void testOptionalException() {
        final List<? super Gear> gears = Lists.newArrayList(); // Low of Covariant compliance for Generic Collection
