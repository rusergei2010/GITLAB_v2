...
public class InvokeAllBasicTest {
    ...
    public void testInvokeAll() throws InterruptedException {
        ...
        assertEquals(10100 /*The stream above makes from Future->String, then makes from String->Integer and sum all elements*/, sum); // Future will not return value (future.get()) until it is calculated
        putDown(service, 2);
    }
