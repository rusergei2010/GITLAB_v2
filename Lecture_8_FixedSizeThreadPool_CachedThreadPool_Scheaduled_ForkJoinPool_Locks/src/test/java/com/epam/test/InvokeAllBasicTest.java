...
public class InvokeAllBasicTest {
    ...
    public void testInvokeAll() throws InterruptedException {
        ...
        assertEquals(100 + 10000 /*What is expected value, and why?*/, sum); // Future will not return value (future.get()) until it is calculated
        putDown(service, 2);
    }
    ...
    public void testRunnableTask() throws InterruptedException {
        ...
        callableTaskCollection.forEach(
                task -> {
                    ...
                    try {
                        Thread.sleep(5000); // TODO: increment this
                    } catch (InterruptedException e) {
                        e.printStackTrace();
                    }
        ...
        Thread.sleep(10000);// TODO: increment this
