...
public class Lambdas03Exercise {
    ...
    public void generic1() {
        final GenericProduct<Integer> prod = (a,b) -> {return a * b;}; // TODO: Use statement com.data.lambda
    ...
    public void generic2() {
        final GenericProduct<Integer> prod = (a,b) -> {return a * b;}; // TODO: Use expression com.data.lambda
    ...
    @Test
    public void strSum() {
        final GenericProduct<String> prod = (String a, int i) -> stringProd(a, i); // TODO: use stringProd;
