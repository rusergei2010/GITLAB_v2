...
public class Mapping {
    ...
    public void mapping() {
        ...
        final List<Employee> mappedEmployees =
                new MapHelper<>(employees)
                        ...
                        .map(e -> e.withJobHistory(fromqaToQA(e.getJobHistory()))) // replace qa with QA
                        .getList();
    ...
    private List<JobHistoryEntry> fromqaToQA(List<JobHistoryEntry> jobHistory) {
        return jobHistory.stream().map(e -> {
            if (e.getPosition().equals("qa"))
                return e.withPosition(e.getPosition().toUpperCase());
            return e.withPosition(e.getPosition());
        })
                .collect(Collectors.toList());
    }
    ...
    public void lazy_mapping() {
        ...
        final List<Employee> mappedEmployees =
                LazyMapHelper.from(employees)
                        ...
                        .map(e -> e.withJobHistory(fromqaToQA(e.getJobHistory())))
                        /*
